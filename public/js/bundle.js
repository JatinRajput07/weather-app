...
var getWeatherReport = function getWeatherReport() {
  var cityName = city.value;
  fetch("".concat(weatherApi.baseUrl, "?q=").concat(cityName, "&appid=").concat(weatherApi.key, "&units=metric")).then(function (weather) {
    return weather.json();
  }).then(showWeatherReport);
};

var showWeatherReport = function showWeatherReport(weather) {
  try {
    document.getElementById('temp').innerHTML = "".concat(Math.round(weather.main.temp), " &deg;C");
    document.getElementById('city_name').innerHTML = " ".concat(weather.name, ",").concat(weather.sys.country); // weather condition

    var tempMood = weather.weather[0].main;
...
var getCurrentDay = function getCurrentDay() {
  ...
  document.getElementById('today_date').innerHTML = "".concat(date, ",").concat(month);
...
},{}],"C:/Users/Jatin Rajput/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/Jatin Rajput/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
